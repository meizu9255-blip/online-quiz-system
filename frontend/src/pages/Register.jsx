...
const Register = () => {
  ...
  const handleOAuthLogin = (provider) => {
    ...
    const popup = window.open('', `${provider} Register`, `width=${width},height=${height},top=${top},left=${left}`);
        ...
        <html><body style="margin:0; font-family: 'Segoe UI', Roboto, sans-serif; background: #202124; color: #e8eaed; display: flex; justify-content: center; padding-top: 40px; user-select: none;">
          <div style="border: 1px solid #5f6368; border-radius: 8px; width: 448px; padding: 36px 40px; background: #202124; box-sizing: border-box;">
            <div style="display: flex; align-items: center; margin-bottom: 16px; justify-content: center;">
              ...
              <span style="font-size: 15px; font-weight: 500;">Регистрация через Google</span>
            </div>
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleRegister}>
            ...
            <div className="form-group" style={{ marginTop: '1.2rem' }}>
              <label style={{ display: 'block', marginBottom: '8px', color: 'var(--text-primary)', fontWeight: 600, fontSize: '0.85rem' }}>Электрондық пошта</label>
              <input type="email" placeholder="you@example.com" value={email} onChange={(e) => setEmail(e.target.value)} required style={{ width: '100%', padding: '12px 16px', borderRadius: '12px', border: '1px solid var(--border)', background: 'var(--bg-input)', color: 'var(--text-primary)', outline: 'none', boxSizing: 'border-box' }} />
            </div>

            <div className="form-group" style={{ marginTop: '1.2rem' }}>
              <label style={{ display: 'block', marginBottom: '8px', color: 'var(--text-primary)', fontWeight: 600, fontSize: '0.85rem' }}>Құпия сөз</label>
              
              {/* Бірінші Құпия сөз өрісі */}
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                <input 
                  ...
                  style={{ width: '100%', padding: '12px 40px 12px 16px', borderRadius: '12px', border: '1px solid var(--border)', background: 'var(--bg-input)', color: 'var(--text-primary)', outline: 'none', letterSpacing: showPassword ? 'normal' : '2px', boxSizing: 'border-box' }} 
                  required 
                />
            ...
            <div className="form-group" style={{ marginTop: '1.2rem', marginBottom: '1.5rem' }}>
              <label style={{ display: 'block', marginBottom: '8px', color: 'var(--text-primary)', fontWeight: 600, fontSize: '0.85rem' }}>Құпия сөзді қайталаңыз</label>
              
              {/* Екінші Құпия сөз өрісі (Растау) */}
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                <input 
                  type={showPassword ? "text" : "password"} 
          ...
          <div style={{ display: 'flex', alignItems: 'center', textAlign: 'center', margin: '1.5rem 0', color: 'var(--text-muted)', fontSize: '0.85rem' }}>
            ...
            <span style={{ padding: '0 10px' }}>немесе арқылы тіркелу</span>
            <div style={{ flex: 1, borderBottom: '1px solid var(--border)' }}></div>
          </div>
